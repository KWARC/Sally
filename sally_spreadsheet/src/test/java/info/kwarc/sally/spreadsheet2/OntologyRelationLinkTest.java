...
public class OntologyRelationLinkTest {
	...
	public void setUp() throws Exception {
		...
		ValueInterpretation vi = new ValueInterpretation("#1", subExpressions, "<ci>Year #1 AD</ci>");
		...
		ValueInterpretation vi2 = new ValueInterpretation("#1", subExpressions2, "<ci>Costtype: #1</ci>");
