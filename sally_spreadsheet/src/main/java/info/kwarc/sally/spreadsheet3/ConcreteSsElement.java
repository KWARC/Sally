...
public class ConcreteSsElement {
	...
	public ConcreteSsElement(CellSpaceInformation position, String value, String formula, ContentValueType valueType) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConcreteSsElement other = (ConcreteSsElement) obj;
		if (formula == null) {
