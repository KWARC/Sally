...
public class RelationInterpreter {
	 ...
	 */
	public static String getDefinition(Relation relation, CellTuple cells, ConcreteSpreadsheet spreadsheet, IOntologyProvider ontologyInterface) {
		String mlDefinition = "";
	 ...
	 */
	public static String interprete(Relation relation, CellTuple cells, ConcreteSpreadsheet spreadsheet, BuilderML builderML) {
